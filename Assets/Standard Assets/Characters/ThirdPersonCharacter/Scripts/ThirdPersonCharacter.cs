...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		public void beBig()
		{
			this.changeSpeed(1.2f);
		}
		private void changeSpeed(float fraction)
        {
			this.m_MovingTurnSpeed = 360;
			this.m_StationaryTurnSpeed = 180;
			this.m_JumpPower = 12f * fraction;
			this.m_GravityMultiplier = 2f;

			this.m_RunCycleLegOffset = 0.2f; //specific to the character in sample assets, will need to be modified to work with others
			this.m_MoveSpeedMultiplier = 1f * fraction;
			this.m_AnimSpeedMultiplier = 1f ;
